...
public class BasicLineZIndex extends BasicLine {
  ...
  protected Component getChart() {
    ...
    PlotOptionsLine options = (PlotOptionsLine) configuration.getPlotOptions(ChartType.LINE);
    ...
    seriesList.forEach(series -> series.setZIndex(seriesCount.decrementAndGet()));
    return chart;
  }
}
