...
public class ServerSideEvents extends AbstractVaadinChartExample {
  ...
  protected Component getChart() {
    ...
    configuration
        .getSubTitle()
        .setText("When an event occurs, the details are shown below the chart");
  ...
  private Layout addEventListeners() {
    ...
    final ChartClickListener listener =
    ...
    final PointClickListener pcListener =
    ...
    final CheckboxClickListener cbListener =
    ...
    final LegendItemClickListener legendItemListener =
        new LegendItemClickListener() {
          @Override
    ...
    final SeriesHideListener hideListener =
        new SeriesHideListener() {
          @Override
    ...
    final SeriesShowListener show =
        new SeriesShowListener() {
          @Override
    ...
    final XAxesExtremesChangeListener xaxesListener =
    ...
    final YAxesExtremesChangeListener yaxesListener =
        new YAxesExtremesChangeListener() {
          @Override
    ...
    final PointSelectListener selectListener =
        new PointSelectListener() {
          @Override
    ...
    final PointUnselectListener unselectListener =
        new PointUnselectListener() {
          @Override
  ...
  private void addToggleForListener(
      String caption, String id, final ListenerToggle listenerToggle) {
  ...
  private Layout createControls() {
    ...
    visibilityToggling.addValueChangeListener(
        e -> {
    ...
    zoomLevels.addValueChangeListener(
