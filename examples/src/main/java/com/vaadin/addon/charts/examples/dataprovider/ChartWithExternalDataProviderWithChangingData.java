...
public class ChartWithExternalDataProviderWithChangingData extends AbstractVaadinChartExample {
  ...
  private ChartDataProvider<?> data =
      new ChartDataProvider<SerializablePredicate<?>>(getMockData());
  ...
  protected Component getChart() {
    ...
    binder
        .forField(field)
        .withValidator((String v) -> v != null && !v.isEmpty(), "The field cannot be empty")
  ...
  private DataProviderSeries<Data> createChartDS() {
    DataProviderSeries<Data> ds = new DataProviderSeries<>(data, Data::getValue);
  ...
  private Component createGrid() {
    ...
    g.addColumn(data -> Double.toString(data.getValue())).setCaption("Data from data provider");
    return g;
  }
  ...
  private static class ChartDataProvider<F> extends AbstractDataProvider<Data, F> {
