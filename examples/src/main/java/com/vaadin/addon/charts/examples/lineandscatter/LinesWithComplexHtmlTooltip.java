...
public class LinesWithComplexHtmlTooltip extends AbstractVaadinChartExample {
  ...
  protected Component getChart() {
    ...
    tooltip.setPointFormat(
        "<tr><td style=\"color: {series.color}\">{series.name}: </td><td style=\"text-align: right\"><b>{point.y} EUR</b></td></tr>");
    ...
    Number[] data =
        new Number[] {
          129.9, 171.5, 106.4, 129.2, 144.0, 176.0, 135.6, 148.5, 216.4, 194.1, 195.6, 154.4
        };
