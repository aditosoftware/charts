...
@SkipFromDemo
public class PointClickCoordinatesTreeMapChart extends AbstractPointClickCoordinatesChart {
  ...
  protected void addSeries(Configuration conf) {
    ...
    series.addAll(
        apples, bananas, oranges, anneA, rickA, peterA, anneB, rickB, peterB, anneO, rickO, peterO,
        susanne);
