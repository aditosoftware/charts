...
public class SimpleChartWithDataProviderSeries extends AbstractVaadinChartExample {
  ...
  private Component createGrid() {
    ...
    grid.addColumn(browser -> Double.toString(browser.getShare().doubleValue())).setCaption("Y");
    grid.addColumn(browser -> browser.getColor().toString()).setCaption("Color");
  ...
  private Collection<Browser> getMockData() {
    ...
    String[] names = new String[] {"MSIE", "Firefox", "Chrome", "Safari", "Opera"};
