...
@SkipFromDemo
public class PointClickCoordinatesDonutChart extends AbstractPointClickCoordinatesChart {
  ...
  private Series createInnerSeries() {
    ...
    innerSeries.setData(
        ...
        new Number[] {55.11, 21.63, 11.94, 7.15, 2.14},
        innerColors);
    return innerSeries;
  }
