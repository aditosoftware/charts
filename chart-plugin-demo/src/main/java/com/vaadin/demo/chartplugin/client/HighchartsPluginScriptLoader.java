...
/**
 * Extends Vaadin Chart's {@link HighchartsScriptLoader} and overrides the {@link
 * #injectResources()} method to inject <code>map.src.js</code> and <code>world-map-shapes.js</code>
 * files in addition to the Vaadin Chart's original resources. </br>This class should also replace
 * the original <code>HighchartsScriptLoader</code> with the following GWT deferred binding in the
 * module XML:</br></br> <code>
