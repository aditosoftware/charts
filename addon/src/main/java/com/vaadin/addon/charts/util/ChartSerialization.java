...
public class ChartSerialization implements Serializable {
  ...
  static {
    ...
    jsonWriterChartOptions =
        defaultMapper
            .setSerializerFactory(
                defaultMapper
                    .getSerializerFactory()
                    .withSerializerModifier(new ChartOptionsBeanSerializerModifier()))
            .writer();
  ...
  /**
   * This method can be used to configure the {@link ObjectMapper} object used to serialize
   * configuration objects to client side. If users have made their extensions to underlying library
   * and wish to build a typed Java API for it, adding custom serializers might be needed.
   *
