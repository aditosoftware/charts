...
public class ChartStyle extends AbstractConfigurationObject {
  ...
  /**
   * Sets the background color of the outer chart area. May be a gradient. Defaults to "#FFFFFF".
   *
  ...
  /**
   * Sets the background color of the plot area. May be a gradient. Defaults to null.
   *
   * @see #setBackgroundColor(Color)
  ...
  /**
   * Sets the background of the plot to an image specified by the provided URL. To set an image as
   * the background for the entire chart, set a CSS background image on the container element.
   * Defaults to null.
   *
   * @param plotBackgroundImage The URL of the background image
   */
  ...
  /**
   * Sets whether to apply a drop shadow to the plot area. Requires that plotBackgroundColor be set.
   *
   * @param plotShadow
   */
   ...
   *
   * @param plotBorderWidth Width of border
   */
  ...
  /**
   * Sets the CSS class name to apply to the container DIV around the chart, allowing unique CSS
   * styling for each chart. Defaults to "".
   *
   * @param className
   */
  ...
  /**
   * Sets the pixel width of the outer chart border. The border is painted using vector graphic
   ...
   *
   * @param borderRadius Radius or border
   */
  ...
  /**
   * Sets the color of the outer chart border. The border is painted using vector graphic techniques
  ...
  /**
   * Gets various style defaults used. This can be used to for example define default font family.
   *
   * @see #setStyle(Style)
   */
  ...
  /**
   * Sets additional CSS styles to apply inline to the container div. Note that since the default
   * font styles are applied in the renderer, it is ignorant of the individual chart options and
   * must be set globally. Defaults to:
   *
   * <p><code>
   * style: {
