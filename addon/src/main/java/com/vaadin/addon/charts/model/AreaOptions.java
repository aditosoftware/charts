...
public abstract class AreaOptions extends AbstractPlotOptions {
   ...
   * animation of the series itself.
   *
  ...
  /**
   * The ID of another series to link to. Additionally, the value can be ":previous" to link to the
   * previous series. When two series are linked, only the first one appears in the legend. Toggling
   * the visibility of this also toggles the linked series.
   */
   ...
   * pointInterval to 10.
   *
   * <p>It can be combined with <code>pointIntervalUnit</code> to draw irregular intervals.
   */
   ...
   *
   * <p>Note that pointPlacement needs a pointRange to work. For column series this is computed, but
   * for line-type series it needs to be set.
   */
