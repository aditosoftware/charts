...
/**
 * The ChartOptions extension configures a page local theme and other global options like localized
 * texts for charts. With this extension it is possible to configure e.g. default colors used by all
 * Chart objects displayed in the UI.
 */
public class ChartOptions extends AbstractExtension {

  @JsonUnwrapped private Theme theme;
   ...
   *
   * <p>Note that if the view is already drawn, all existing {@link Chart}s will be redrawn.
   *
   * @param theme
   */
  ...
  /**
   * Returns the {@link Theme} in use or {@code null} if no theme has been set.
   *
  ...
  /**
   * Returns the {@link Global} in use or {@code null} if no lang configuration has been set.
   *
  ...
  /**
   * Returns a ChartOptions extension for the given UI. If a ChartOptions extension has not yet been
   * added, a new one is created and added.
   *
   * @param ui the UI for which the ChartOptions should be returned
  ...
  /**
   * Returns a ChartOptions extension for the current UI. If a ChartOptions extension has not yet
   * been added, a new one is created and added.
   *
