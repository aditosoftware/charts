...
public class Level extends AbstractConfigurationObject {
  ...
  /**
   * Set the dash style of the border of all the point which lies on the level. See <a
   * href"#plotOptions.scatter.dashStyle">plotOptions.scatter.dashStyle</a> for possible options.
   */
  ...
  /**
   * Can set the options of dataLabels on each point which lies on the level. <a
   * href="#plotOptions.treemap.dataLabels">plotOptions.treemap.dataLabels</a> for possible values.
   *
