...
public class TreeSeriesItem extends AbstractSeriesItem {
  ...
  /**
   * The value should be the id of the point which is the parent. If no points has a matching id, or
   * this option is null, then the parent will be set to the root. Defaults to null.
   *
   * @param parent
   */
