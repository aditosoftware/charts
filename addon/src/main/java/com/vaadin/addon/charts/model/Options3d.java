...
public class Options3d extends AbstractConfigurationObject {
  ...
  /**
   * Provides the option to draw a frame around the charts by defining a bottom, front and back
   * panel.
   */
  ...
  /**
   * Defines the distance the viewer is standing in front of the chart, this setting is important to
   * calculate the perspective effect in column and scatter charts. It is not used for 3D pie
   * charts.
   *
   * <p>Defaults to: 100
   */
