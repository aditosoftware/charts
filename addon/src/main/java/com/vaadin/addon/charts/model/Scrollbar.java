...
/**
 * An optional scrollbar to display on the Y axis in response to limiting the minimum an maximum of
 * the axis values.
 */
@Generated(
...
public class Scrollbar extends AbstractConfigurationObject {
   ...
   * Defaults to <code>true</code> for modern browsers and <code>false</code> for legacy IE browsers
  ...
  /**
   * Whether to show the scrollbar when it is fully zoomed out at max range. Setting it to <code>
   * false</code> on the Y axis makes the scrollbar stay hidden until the user zooms in, like common
   * in browsers.
   *
   * <p>Defaults to: true
   */
  ...
  /**
   * The width of a vertical scrollbar or height of a horizontal scrollbar. Defaults to 20 on touch
   * devices.
   *
   * <p>Defaults to: 14
   */
