...
/**
 * In Highcharts 1.0, the appearance of all markers belonging to the hovered series. For settings on
 * the hover state of the individual point, see <a
...
public class Marker extends AbstractConfigurationObject {
  ...
  /**
   * Enable or disable the point marker. If <code>null</code>, the markers are hidden when the data
   * is dense, and shown for more widespread data points.
   *
   * <p>Defaults to: null
   */
  ...
  /**
   * The fill color of the point marker. When <code>null</code>, the series' or point's color is
   * used.
   */
  ...
  /**
   * Image markers only. Set the image width explicitly. When using this option, a <code>width
  ...
  /**
   * Image markers only. Set the image width explicitly. When using this option, a <code>height
   * </code> must also be set.
   *
   * <p>Defaults to: null
   */
