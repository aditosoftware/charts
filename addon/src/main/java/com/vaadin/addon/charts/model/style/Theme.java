...
/**
 * Theme class for Chart. This is empty theme, and only defines the structure of Theme. Inherit own
 * Theme class, or use Themes inherited from this class to theme your Charts.
 *
 * @see VaadinTheme
 */
public class Theme extends AbstractConfigurationObject {
   ...
   *
   * @param style New style of title
   */
   ...
   *
   * @param style New style of subtitle
   */
