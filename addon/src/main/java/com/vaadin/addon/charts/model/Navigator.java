...
public class Navigator extends AbstractConfigurationObject {
  ...
  /**
   * Whether the navigator and scrollbar should adapt to updated data in the base X axis. When
   * loading data async, as in the demo below, this should be <code>false</code>. Otherwise new data
   * will trigger navigator redraw, which will cause unwanted looping. In the demo below, the data
   * in the navigator is set only once. On navigating, only the main chart content is updated.
   *
   * <p>Defaults to: true
   */
  ...
  /**
   * The color of the mask covering the areas of the navigator series that are currently not visible
   * in the main series. The default color is bluish with an opacity of 0.3 to see the series below.
   *
   * <p>Defaults to: rgba(128,179,236,0.3)
   */
  ...
  /**
   * Whether the mask should be inside the range marking the zoomed range, or outside. In Highstock
   * 1.x it was always <code>false</code>.
   *
   * <p>Defaults to: true
   */
  ...
  /**
   * Options for the navigator series. Available options are the same as any series, documented at
   * <a class="internal" href="#plotOptions.series">plotOptions</a> and <a class="internal"
   * href="#series">series</a>.
   *
   * <p>Unless data is explicitly defined on navigator.series, the data is borrowed from the first
   * series in the chart.
   *
   * <p>Default series options for the navigator series are:
   *
   * <pre>
   * series: {
   * 		type: 'areaspline',
  ...
  /**
   * Options for the navigator X axis. Available options are the same as any X axis, documented at
   * <a class="internal" href="#xAxis">xAxis</a>. Default series options for the navigator xAxis
   * are:
   *
   * <pre>
   * xAxis: {
  ...
  /**
   * Options for the navigator Y axis. Available options are the same as any y axis, documented at
   * <a class="internal" href="#yAxis">yAxis</a>. Default series options for the navigator yAxis
   * are:
   *
   * <pre>
   * yAxis: {
