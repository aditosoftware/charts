...
public class Label extends AbstractConfigurationObject {
  ...
  /**
   * Rotation of the text label in degrees. Defaults to 0 for horizontal plot lines and 90 for
   * vertical lines.
   */
   ...
   * point is placed within the plot band, <code>textAlign</code> determines how the text is aligned
   * against its anchor point. Possible values are "left", "center" and "right". Defaults to the
