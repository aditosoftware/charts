...
public abstract class AbstractDataLabels extends AbstractConfigurationObject {
  ...
  /**
   * A format string for the data label. Available variables are the same as for <code>formatter
   * </code>.
   */
  ...
  /**
   * Callback JavaScript function to format the data label. Note that if a <code>format</code> is
   * defined, the format takes precedence and the formatter is ignored.
   */
  ...
  public abstract Boolean getReserveSpace();
   ...
   */
  public abstract void setReserveSpace(Boolean reserveSpace);
