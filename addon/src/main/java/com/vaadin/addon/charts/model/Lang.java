 ...
 * Instead, use <code>Highcharts.setOptions</code> to set it before any chart is initiated.
 *
 * <pre>
...
public class Lang extends AbstractConfigurationObject {
  ...
  /**
   * Exporting module menu. The tooltip title for the context menu holding print and export menu
   * items.
   *
   * <p>Defaults to: Chart context menu
   */
  ...
  /**
   * The default decimal point used in the <code>Highcharts.numberFormat</code> method unless
   * otherwise specified in the function arguments.
   *
   * <p>Defaults to: .
   */
   ...
   *
   * <p>Defaults to: Download JPEG image
   */
   ...
   *
   * <p>Defaults to: Download PDF document
   */
   ...
   *
   * <p>Defaults to: Download PNG image
   */
   ...
   *
   * <p>Defaults to: Download SVG vector image
   */
  ...
  /**
   * The text for the button that appears when drilling down, linking back to the parent series. The
   * parent series' name is inserted for <code>{series.name}</code>.
   *
   * <p>Defaults to: Back to {series.name}
   */
  ...
  /**
   * An array containing the months names. Corresponds to the <code>%B</code> format in <code>
   * Highcharts.dateFormat()</code>.
   *
   * <p>Defaults to: [ "January" , "February" , "March" , "April" , "May" , "June" , "July" ,
  ...
  /**
   * The text to display when the chart contains no data. Requires the no-data module, see <a
   * href="#noData">noData</a>.
   *
   * <p>Defaults to: No data to display
   */
  ...
  /**
   * Metric prefixes used to shorten high numbers in axis labels. Setting numericSymbols to null
   * sets default values. Setting numericSymbols to an empty array disables shortening - shows
   * initial numbers.
   *
   * <p>Defaults to: [ "k" , "M" , "G" , "T" , "P" , "E"]
   */
   ...
   *
   * <p>Defaults to: Reset zoom level 1:1
   */
  ...
  /**
   * An array containing the months names in abbreviated form. Corresponds to the <code>%b</code>
   * format in <code>Highcharts.dateFormat()</code>.
   *
   * <p>Defaults to: [ "Jan" , "Feb" , "Mar" , "Apr" , "May" , "Jun" , "Jul" , "Aug" , "Sep" , "Oct"
   * , "Nov" , "Dec"]
   */
  ...
  /**
   * Short week days, starting Sunday. If not specified, Highcharts uses the first three letters of
   * the <code>lang.weekdays</code> option.
   */
  ...
  /**
   * The default thousands separator used in the <code>Highcharts.numberFormat</code> method unless
   * otherwise specified in the function arguments. Since Highcharts 4.1 it defaults to a single
   * space character, which is compatible with ISO and works across Anglo-American and continental
   * European languages.
   *
   * <p>Defaults to:
   */
   ...
   *
   * <p>Defaults to: ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"]
   */
