...
public class ResetZoomButton extends AbstractConfigurationObject {
  ...
  /**
   * A collection of attributes for the button. The object takes SVG attributes like <code>fill
   * </code>, <code>stroke</code>, <code>stroke-width</code> or <code>r</code>, the border radius.
   * The theme also supports <code>style</code>, a collection of CSS properties for the text.
