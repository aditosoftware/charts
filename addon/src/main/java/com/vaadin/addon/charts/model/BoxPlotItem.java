...
/**
 * A DataSeriesItem implementation suitable for <a href="http://en.wikipedia.org/wiki/Box_plot">box
 * plot charts</a>. Plot box charts visualize well some statistical data.
 *
...
public class BoxPlotItem extends DataSeriesItem {
   ...
   * @param high
   */
  public BoxPlotItem(Number low, Number q1, Number median, Number q3, Number high) {
    this();
    setLow(low);
    setHigh(high);
    setMedian(median);
