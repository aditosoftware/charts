...
/**
 * Extension for {@link Chart} which generates the data as a simple Sparkline. The Sparkline is
 * always a {@link ChartType#LINE}.
 *
 * <p>Note that the configuration is done only at construction time. Further modifications to the
 * object can break the styling.
 *
 * @see <a href="http://en.wikipedia.org/wiki/Sparkline">Sparkline in Wikipedia</a>
 */
