...
public class Credits extends AbstractConfigurationObject {
   ...
   *
   * <p>Defaults to: http://www.highcharts.com
   */
  ...
  /**
   * Position configuration for the credits label. Supported properties are <code>align</code>,
   * <code>verticalAlign</code>, <code>x</code> and <code>y</code>. Defaults to
   *
   * <pre>
   * position: {
   * 		align: 'right',
