...
/**
 * Options for displaying a message like "No data to display". This feature requires the file <code>
 * no-data-to-display.js</code> to be loaded in the page. The actual text to display is set in the
...
public class NoData extends AbstractConfigurationObject {
   ...
   *
   * <p>Defaults to: { "x": 0, "y": 0, "align": "center", "verticalAlign": "middle" }
   */
   ...
   *
   * <p>Defaults to: { "fontSize": "12px", "fontWeight": "bold", "color": "#60606a" }
   */
