...
public class GradientColor implements Color {
   ...
   *
   * @param d The relative point of the color stop, between 0 and 1
   * @param color The color at the point defined by d
   */
  ...
  /**
   * Creates a new linear gradient between two given points. Use {@link #addColorStop(double,
   * SolidColor)} to define the colors.
   *
   * @param startX The relative start point on the X-axis, 0..1
   * @param startY The relative start point on the Y-axis, 0..1
   * @param endX The relative end point on the X-axis, 0..1
   * @param endY The relative end point on the Y-axis, 0..1
  ...
  /**
   * Creates a radial gradient color at a specified point with the given radius. Use {@link
   * #addColorStop(double, SolidColor)} to define the colors.
   *
