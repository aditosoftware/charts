...
public class TimeUnitMultiplesSerializer extends JsonSerializer<TimeUnitMultiples> {
  ...
  public static Module getModule() {
    ...
    module.addSerializer(TimeUnitMultiples.class, new TimeUnitMultiplesSerializer());
    return module;
  }

  @Override
  public void serialize(TimeUnitMultiples value, JsonGenerator gen, SerializerProvider serializers)
