...
public class ItemSlicedEvent extends AbstractSeriesEvent {
   ...
   * @param animation
   */
  public ItemSlicedEvent(
      Series series, int index, boolean sliced, boolean redraw, boolean animation) {
    super(series);
    this.index = index;
    this.sliced = sliced;
    this.redraw = redraw;
  ...
  /**
   * When true, the point is sliced out. When false, the point is set in. When null or undefined,
   ...
   *
   * @return <b>true</b> when redrawing needs to be immediate, <b>false</b> otherwise.
   */
   ...
   *
   * @return <b>true</b> when slicing should be animated, <b>false</b> otherwise.
   */
