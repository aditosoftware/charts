...
public class Title extends AbstractConfigurationObject {
  ...
  /**
   * The margin between the title and the plot area, or if a subtitle is present, the margin between
  ...
  /**
   * CSS styles for the title. Use this for font styling, but use <code>align</code>, <code>x</code>
   * and <code>y</code> for text alignment.
   *
   * <p>Defaults to: { "color": "#333333", "fontSize": "18px" }
   */
  ...
  /**
   * The vertical alignment of the title. Can be one of "top", "middle" and "bottom". When a value
   * is given, the title behaves as floating.
   *
   * <p>Defaults to:
   */
   ...
   * href="#chart.spacingBottom">chart.spacingBottom</a>. By default it depends on the font size.
   */
