 ...
 *
 * <p>xAxis and yAxis will be available depending on the zoomType that was configured for the chart.
...
public class ChartSelectionEvent extends JavaScriptObject {
  ...
  public final native double getSelectionStart() /*-{
  ...
  public final native double getSelectionEnd() /*-{
        if(this.xAxis && this.xAxis[0]){
  ...
  public final native double getValueStart() /*-{
  ...
  public final native double getValueEnd() /*-{
        if(this.yAxis && this.yAxis[0]){
