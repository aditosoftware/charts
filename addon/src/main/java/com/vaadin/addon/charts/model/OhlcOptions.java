...
public abstract class OhlcOptions extends AbstractPlotOptions {
   ...
   * readability and increase performance of the JavaScript charts. By default data grouping is
   * applied when the points become closer than a certain pixel value, determined by the
  ...
  /**
   * When this is true, the series will not cause the Y axis to cross the zero plane unless the data
   ...
   * conjunction with negativeColor.
   */
