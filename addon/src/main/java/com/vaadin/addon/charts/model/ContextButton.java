...
public class ContextButton extends AbstractConfigurationObject {
  ...
  /**
   * The symbol for the button. Points to a definition function in the <code>
   * Highcharts.Renderer.symbols</code> collection. The default <code>exportIcon</code> function is
  ...
  /**
   * A configuration object for the button theme. The object accepts SVG properties like <code>
   * stroke-width</code>, <code>stroke</code> and <code>fill</code>. Tri-state button styles are
   * supported by the <code>states.hover</code> and <code>states.select</code> objects.
   */
