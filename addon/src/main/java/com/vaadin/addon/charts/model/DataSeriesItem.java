...
public class DataSeriesItem extends AbstractSeriesItem {
   ...
   * rendering library.
   */
  @JsonIgnore private boolean customized = false;
  ...
  /**
   * Constructs an item with a name and a value on the Y-axis and assigns the specified color to the
   * item.
   *
   * @param name Name of the item.
   * @param y Y-value of the item.
  ...
  /**
   * Constructs an item with numerical values for the X and Y axes and assigns the specified color
   * to the item.
   *
   * @param x X-value of the item.
   * @param y Y-value of the item.
   ...
   *
   * @param instant Instant of the item, as its X-value.
   * @param y Y-value of the item.
   */
  ...
  /**
   * Constructs a DataSeriesItem with the given instant as X value with min and max values for use
  ...
  /**
   * Constructs a DataSeriesItem with the given X, min and max values for use in range
   * visualizations.
   *
   * @param x X-value of the item.
   * @param low Lower value for range visualization.
   ...
   *
   * <p><em>Note</em> This is only applicable for gauge charts.
   *
   ...
   *
   * @return The dial or arrow pointer of a gauge chart. Only applicable for gauge charts.
   * @see #setDial(Dial)
   */
  public Dial getDial() {
    return dial;
   ...
   *
   * @return <b>true</b> if the data series item can be rendered in optimized manner, <b>false</b>
   *     otherwise.
   */
  ...
  /**
   * The ID of a series in the {@link Drilldown#addSeries(Series)} list to use for a drilldown for
   * this point. If the value doesn't correspond to the ID of a series the point will be shown as if
   * drilldown was enabled and a {@link DrilldownCallback} will be triggered when user clicks in a
   * point.
   *
   * @param drilldown
   */
  ...
  /**
   * True to enable drilldown and a {@link DrilldownCallback} will be triggered when user clicks in
   * a point.
   *
   * @param drilldown
   */
   ...
   *
   * <p>Accepts CSS <code>cursor</code> values like: alias, all-scroll, auto, cell, context-menu,
   * col-resize, copy, crosshair, default, e-resize, ew-resize, grab, grabbing, help, move,
   * n-resize, ne-resize, nesw-resize, ns-resize, nw-resize, nwse-resize, no-drop, none,
   * not-allowed, pointer, progress, row-resize, s-resize, se-resize, sw-resize, text,
   * vertical-text, w-resize, wait, zoom-in, zoom-out
   *
   * <p>Note that not all browsers have support for all values.
   *
   * @param cursor
   */
