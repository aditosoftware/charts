...
public class HighChartsDefaultTheme extends Theme {
  ...
  public HighChartsDefaultTheme() {
    ...
    setColors(
        new SolidColor("#2f7ed8"),
        new SolidColor("#0d233a"),
        new SolidColor("#8bbc21"),
        new SolidColor("#910000"),
        new SolidColor("#1aadce"),
        new SolidColor("#492970"),
        new SolidColor("#f28f43"),
        new SolidColor("#77a1e5"),
        new SolidColor("#c42525"),
        new SolidColor("#a6c96a"));
