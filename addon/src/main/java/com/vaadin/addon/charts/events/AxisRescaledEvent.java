...
/**
 * Event for information about rescaling the axis. Wraps <code>Axis.setExtremes()</code>.
 *
 * @since 2.0
 */
public class AxisRescaledEvent implements Serializable {
   ...
   *
   * @param axis Number depicting the dimension of the axis. 0 is X, 1 is Y, etc.
   * @param axisIndex Index of the axis.
   * @param minimum Minimum value on the axis.
   * @param maximum Maximum value on the axis.
   * @param redraw Whether or not to redraw the chart.
   * @param animate Whether or not to animate the rescaling.
   */
  public AxisRescaledEvent(
      short axis, int axisIndex, Number minimum, Number maximum, boolean redraw, boolean animate) {
    this.axis = axis;
   ...
   *
   * @param axis Number depicting the dimension of the axis. 0 is X, 1 is Y, etc.
   * @param axisIndex The axis that was resized.
   * @param minimum Minimum value on the axis.
   * @param maximum Maximum value on the axis.
   * @param redraw Whether or not to redraw the chart.
   */
  public AxisRescaledEvent(
      short axis, int axisIndex, Number minimum, Number maximum, boolean redraw) {
   ...
   * @param maximum Maximum value on the axis.
   */
  public AxisRescaledEvent(short axis, int axisIndex, Number minimum, Number maximum) {
   ...
   *
   * @return <b>true</b> when chart needs to be redrawn, <b>false</b> otherwise.
   */
   ...
   *
   * @return <b>true</b> when redrawing should be animated, <b>false</b> otherwise.
   */
