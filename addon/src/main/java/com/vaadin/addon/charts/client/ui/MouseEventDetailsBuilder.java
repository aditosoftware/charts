...
/**
 * Helper class for constructing a MouseEventDetails object from different types of {@link
 * AbstractClickEvent}.
 */
public class MouseEventDetailsBuilder {

  /**
   * Construct a {@link MouseEventDetails} object from the given {@link ChartClickEvent}
   *
   * @param event The event to use as a source for the details
   * @param relativeToObject The element used to calculate {@link MouseEventDetails#getxValue()} and
  ...
  /**
   * Construct a {@link MouseEventDetails} object from the given {@link PointClickEvent}
   *
   * @param event The event to use as a source for the details
   * @param relativeToObject The element used to calculate {@link MouseEventDetails#getxValue()} and
   *     {@link MouseEventDetails#getyValue()}
   ...
   * @param relativeToObject The element whose position {@link MouseEventDetails#getxValue()} ()}
   *     and {@link MouseEventDetails#getyValue()} ()} are relative to.
   * @return a MouseEventDetails containing information from the event
   */
  public static MouseEventDetails buildMouseEventDetails(
      NativeEvent evt, UIObject relativeToObject) {
    MouseEventDetails mouseEventDetails = new MouseEventDetails();
   ...
   *
   * @param details object to be initialized
   * @param event The event to use as a source for the details
   */
  private static void initCommonValues(MouseEventDetails details, AbstractClickEvent event) {
