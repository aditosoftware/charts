...
public class TooltipStyle extends AbstractConfigurationObject {
  ...
  /** @param followPointer the followPointer to set */
  ...
  /**
   * Sets the color of the tooltip border. When null, the border takes the color of the
   * corresponding series or point. Defaults to null.
   *
   * @param borderColor
   */
