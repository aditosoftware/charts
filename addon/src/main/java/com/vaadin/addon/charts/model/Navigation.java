...
public class Navigation extends AbstractConfigurationObject {
  ...
  /**
   * CSS styles for the individual items within the popup menu appearing by default when the export
   * icon is clicked. The menu items are rendered in HTML. Defaults to
   *
   * <pre>
   * menuItemStyle: {
   * 		padding: '0 5px',
