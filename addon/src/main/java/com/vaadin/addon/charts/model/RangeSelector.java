...
public class RangeSelector extends AbstractConfigurationObject {
  ...
  /**
   * Whether to enable all buttons from the start. By default buttons are only enabled if the
   * corresponding time range exists on the X axis, but enabling all buttons allows for dynamically
   * loading different time ranges.
   *
   * <p>Defaults to: false
   */
  ...
  /**
   * A collection of attributes for the buttons. The object takes SVG attributes like <code>fill
   * </code>, <code>stroke</code>, <code>stroke-width</code>, as well as <code>style</code>, a
   * collection of CSS properties for the text.
   *
   * <p>The object can also be extended with states, so you can set presentational options for
   * <code>hover</code>, <code>select</code> or <code>disabled</code> button states.
   */
   ...
   *   <dt><code>count</code>
   *   <dd>Defines how many units of the defined type to use.
   *   <dt><code>dataGrouping</code>
   *   <dd>A custom data grouping definition for the button.
   *   <dt><code>text</code>
   *   <dd>The text for the button itself
   * </dl>
   *
   * Defaults to
   *
  ...
  public void setButtons(RangeSelectorButton... buttons) {
    this.buttons = new ArrayList<RangeSelectorButton>(Arrays.asList(buttons));
  }
  ...
  /**
   * The date format in the input boxes when not selected for editing. Defaults to <code>%b %e, %Y
   * </code>.
   *
   * <p>Defaults to: %b %e %Y,
   */
  ...
  /**
   * The date format in the input boxes when they are selected for editing. This must be a format
   * that is recognized by JavaScript Date.parse.
   *
   * <p>Defaults to: %Y-%m-%d
   */
  ...
  /**
   * Enable or disable the date input boxes. Defaults to enabled when there is enough space,
   * disabled if not (typically mobile).
   */
  ...
  /**
   * Positioning for the input boxes. Allowed properties are <code>align</code>, <code>verticalAlign
   * </code>, <code>x</code> and <code>y</code>.
   *
   * <p>Defaults to: { align: "right" }
   */
