...
public abstract class AbstractSeriesEvent extends com.vaadin.ui.Component.Event {

  private final Series series;
  private final int seriesItemIndex;

  public AbstractSeriesEvent(Component source, Series series, int seriesItemIndex) {
    super(source);
    this.series = series;
