...
public class Subtitle extends AbstractConfigurationObject {
  ...
  /**
   * CSS styles for the title. Exact positioning of the title can be achieved by changing the margin
   * property, or by adding <code>position: "absolute"</code> and left and top properties.
   *
   * <p>Defaults to: { "color": "#555555" }
   */
   ...
   * chart.spacingBottom. By default the subtitle is laid out below the title unless the title is
   * floating.
   *
   * <p>Defaults to: null
   */
