 ...
 *
 * <p>See <a class="internal" href="#Axis">the Axis object</a> for programmatic access to the axis.
 */
@Generated(
...
public class XAxis extends Axis {
   ...
   * the edge of the plot area. When the axis' <code>max</code> option is set or a max extreme is
   * set using <code>axis.setExtremes()</code>, the maxPadding will be ignored.
   *
   * <p>Defaults to: 0.01
   */
   ...
   * the edge of the plot area. When the axis' <code>min</code> option is set or a min extreme is
   * set using <code>axis.setExtremes()</code>, the minPadding will be ignored.
   *
   * <p>Defaults to: 0.01
   */
   ...
   *
   * <p>In a gauge, a plot band on the Y axis (value axis) will stretch along the perimeter of the
   * gauge.
   */
