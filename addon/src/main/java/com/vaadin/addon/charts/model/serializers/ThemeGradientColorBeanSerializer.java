...
public class ThemeGradientColorBeanSerializer extends BeanSerializerBase {
  ...
  public ThemeGradientColorBeanSerializer(
      BeanSerializerBase source, ObjectIdWriter objectIdWriter) {
    super(source, objectIdWriter);
  }

  public ThemeGradientColorBeanSerializer(BeanSerializerBase source, String[] toIgnore) {
    super(source, toIgnore);
  }

  protected ThemeGradientColorBeanSerializer(BeanSerializerBase source, Set<String> toIgnore) {
    super(source, toIgnore);
  }

  public ThemeGradientColorBeanSerializer(BeanSerializerBase source, Object filterId) {
