...
public class AxisTitle extends AbstractConfigurationObject {
  ...
  /**
   * The pixel distance between the axis labels and the title. Positive values are outside the axis
   * line, negative are inside.
   *
   * <p>Defaults to: 40
   */
   ...
   * techniques and not all styles are applicable.
   *
   * <p>Defaults to: { "color": "#707070", "fontWeight": "bold" }
   */
  ...
  /**
   * The actual text of the axis title. Horizontal texts can contain HTML, but rotated texts are
   * painted using vector techniques and must be clean text. The Y axis title is disabled by setting
   * the <code>text</code> option to <code>null</code>.
   *
   * <p>Defaults to: Values
   */
