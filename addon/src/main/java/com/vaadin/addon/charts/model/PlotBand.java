...
public class PlotBand extends AbstractConfigurationObject {
  ...
  /**
   * Sets the innerRadius using String presentation. String presentation is similar to what is used
   ...
   *
   * @param innerRadius CSS style string representation
   */
  ...
  /**
   * Sets the innerRadius using Vaadin Unit. Only Unit.PIXELS and Unit.PERCENTAGE are supported. In
   * all other cases, IllegalArgumentException is thrown.
   *
   * @param innerRadius
   * @param unit the unit used for the innerRadius
   */
  ...
  /**
   * Sets the outerRadius using String presentation. String presentation is similar to what is used
   * in Cascading Style Sheets. Size can be pixels or percentage, otherwise IllegalArgumentException
   * is thrown. The empty string ("") or null will unset the height and set the units to pixels.
   *
   * @param outerRadius CSS style string representation
   */
  ...
  /**
   * Sets the outerRadius using Vaadin Unit. Only Unit.PIXELS and Unit.PERCENTAGE are supported. In
   * all other cases, IllegalArgumentException is thrown.
   *
   * @param outerRadius
   * @param unit the unit used for the outerRadius
   */
  ...
  /**
   * Sets the thickness using String presentation. String presentation is similar to what is used in
   ...
   *
   * @param thickness CSS style string representation
   */
  ...
  /**
   * Sets the thickness using Vaadin Unit. Only Unit.PIXELS and Unit.PERCENTAGE are supported. In
   * all other cases, IllegalArgumentException is thrown.
   *
   * @param thickness
   * @param unit the unit used for the thickness
   */
  ...
  /**
   * The z index of the plot band within the chart, relative to other elements. Using the same z
   * index as another element may give unpredictable results, as the last rendered element will be
   * on top. Values from 0 to 20 make sense.
   */
