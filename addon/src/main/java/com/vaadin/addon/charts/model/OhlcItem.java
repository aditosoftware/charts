 ...
 * https://en.wikipedia.org/wiki/Open-high-low-close_chart">OHLC charts</a>. OHLC charts visualize
 * well financial data.
 *
 * @see PlotOptionsOhlc
...
public class OhlcItem extends DataSeriesItem {
   ...
   * @param close
   */
  public OhlcItem(Instant instant, Number open, Number high, Number low, Number close) {
    this();
    setX(instant);
    setOpen(open);
    setLow(low);
