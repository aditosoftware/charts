...
/**
 * A collection of {@link TreeSeriesItem TreeSeriesItems} that compose a multi-root tree. This
 * series is meant to be used with {@link ChartType#TREEMAP} charts.
 */
public class TreeSeries extends AbstractSeries {
   ...
   *
   * @param name The name of this series
   * @param data The data of this series
   */
  ...
  /**
   * Set the list of {@link TreeSeriesItem} in this series. The items are the whole tree, and the
   * list is not ordered.
   *
   * @param data
   */
