...
/**
 * The LegendItemClickEvent class stores information on click events on the charts's legend items.
 */
public class LegendItemClickEvent extends AbstractSeriesEvent {
   ...
   */
  public LegendItemClickEvent(
      Chart source, Series series, int seriesItemIndex, MouseEventDetails mouseEventDetails) {
