...
public class ChartModel extends AbstractConfigurationObject {
   ...
   * <code>alignTicks</code> to false. If the grid lines look messy, it's a good idea to hide them
   * for the secondary axis by setting <code>gridLineWidth</code> to 0.
   *
   * <p>Defaults to: true
   */
   ...
   * , it will use the 'swing' jQuery easing and a duration of 500 ms. If used as a configuration
  ...
  /**
   * An explicit height for the chart. By default (when <code>null</code>) the height is calculated
   * from the offset height of the containing element, or 400 pixels if the containing element's
   * height is 0.
   *
   * <p>Defaults to: null
   */
   ...
   * once one series within the stack is hidden, the rest of the stack will close in around it even
  ...
  /**
   * Whether to invert the axes so that the x axis is vertical and y axis is horizontal. When true,
   * the x axis is <a href="#xAxis.reversed">reversed</a> by default. If a bar series is present in
   * the chart, it will be inverted automatically.
   *
   * <p>Inverting the chart doesn't have an effect if there are no cartesian series in the chart, or
   * if the chart is <a href="#chart.polar">polar</a>.
   *
   * <p>Defaults to: false
   */
   ...
   * fixed pixel value for the margin as opposed to the default dynamic margin. See also <code>
   * spacingBottom</code>.
   */
   ...
   * pixel value for the margin as opposed to the default dynamic margin. See also <code>spacingLeft
   * </code>.
   */
   ...
   * pixel value for the margin as opposed to the default dynamic margin. See also <code>
   * spacingRight</code>.
   */
   ...
   * pixel value for the margin as opposed to the default dynamic margin. See also <code>spacingTop
   * </code>.
   */
  ...
  /**
   * Options to render charts in 3 dimensions. This feature requires <code>highcharts-3d.js</code>,
   * found in the download package or online at <a
   * href="http://code.highcharts.com/highcharts-3d.js">code.highcharts.com/ highcharts-3d.js</a>.
   */
  ...
  /**
   * Allow panning in a chart. Best used with <a href="#chart.panKey">panKey</a> to combine zooming
   * and panning.
   *
   * <p>Defaults to: false
   */
  ...
  /**
   * Equivalent to <a href="#chart.zoomType">zoomType</a>, but for multitouch gestures only. By
   * default, the <code>pinchType</code> is the same as the <code>zoomType</code> setting. However,
   * pinching can be enabled separately in some cases, for example in stock charts where a mouse
   ...
   * entire chart, set a CSS background image to the container element. Note that for the image to
   * be applied to exported charts, its URL needs to be accessible by the export server.
   */
   ...
   * Since 2.3 the shadow can be an object configuration containing <code>color</code>, <code>
   * offsetX</code>, <code>offsetY</code>, <code>opacity</code> and <code>width</code>.
   *
   * <p>Defaults to: false
   */
   ...
   * coordinate system. Requires <code>highcharts-more.js</code>.
   *
   * <p>Defaults to: false
   */
   ...
   *
   * <p>Defaults to: rgba(69,114,167,0.25)
   */
   ...
   * dynamically, as axes are automatically added to cartesian series.
   *
   * <p>Defaults to: false
   */
  ...
  /**
   * The distance between the outer edge of the chart and the content, like title, legend, axis
   * title or labels. The numbers in the array designate top, right, bottom and left respectively.
   * Use the options spacingTop, spacingRight, spacingBottom and spacingLeft options for shorthand
   * setting of one option.
   *
   * <p>Defaults to: [10, 10, 15, 10]
   */
  ...
  /**
   * Additional CSS styles to apply inline to the container <code>div</code>. Note that since the
   * default font styles are applied in the renderer, it is ignorant of the individual chart options
   ...
   * </pre>
   *
   * <p>Defaults to: {"fontFamily": "\"Lucida Grande\", \"Lucida Sans Unicode\", Verdana, Arial,
  ...
  /**
   * The default series type for the chart. Can be any of the chart types listed under <a
   * href="#plotOptions">plotOptions</a>.
   *
   * <p>Defaults to: line
   */
  ...
  /**
   * An explicit width for the chart. By default (when <code>null</code>) the width is calculated
  ...
  /**
   * Decides in what dimensions the user can zoom by dragging the mouse. Can be one of <code>x
   * </code>, <code>y</code> or <code>xy</code>.
   */
  ...
  /**
   * Sets the vertical margin for top and bottom and the horizontal margin for the right and left
   * margin
   */
