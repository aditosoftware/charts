...
public class Pane extends AbstractConfigurationObject {
  ...
  /**
   * An object, or array of objects, for backgrounds. Sub options include <code>backgroundColor
   * </code> (can be solid or gradient), <code>shape</code> ("solid" or "arc"), <code>innerWidth
   * </code>, <code>outerWidth</code>, <code>borderWidth</code>, <code>borderColor</code>.
   */
  ...
  /**
   * The center of a polar chart or angular gauge, given as an array of [x, y] positions. Positions
   * can be given as integers that transform to pixels, or as percentages of the plot area size.
   *
   * <p>Defaults to: ["50%", "50%"]
   */
   ...
   * Defaults to <a href="#pane.startAngle">startAngle</a> + 360.
   */
  ...
  /**
   * The start angle of the polar X axis or gauge axis, given in degrees where 0 is north. Defaults
   * to 0.
   */
