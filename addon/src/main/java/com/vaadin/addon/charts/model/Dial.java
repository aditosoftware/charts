...
public class Dial extends AbstractConfigurationObject {
  ...
  /**
   * The border color or stroke of the gauge's dial. By default, the borderWidth is 0, so this must
   * be set in addition to a custom border color.
   *
  ...
  /**
   * The width of the top of the dial, closest to the perimeter. The pivot narrows in from the base
   * to the top.
   *
   * <p>Defaults to: 1
   */
