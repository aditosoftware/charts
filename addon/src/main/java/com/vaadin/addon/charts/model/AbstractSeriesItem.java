...
public class AbstractSeriesItem extends AbstractConfigurationObject {
   ...
   * @return <b>true</b> when this data item is displayed offset from the center in a pie chart,
   *     <b>false</b> otherwise.
   */
  ...
  /**
   * Sets whether to display a slice offset from the center. Defaults to false.
   *
   * <p><em>Note</em>: This applies to pie charts only.
   *
   * @param sliced When <b>true</b>, this item should be displayed with a small offset from the
   *     centre of the pie chart; when <b>false</b>, this item will be rendered normally.
   */
  ...
  /**
   * Sets the individual color for the point. Defaults to null. This might not work for all chart
   * types.
   *
   ...
   * @return The index of the legend or null if not defined. Only applicable for pie charts.
   */
  ...
  /**
   * Sets the sequential index of the pie slice in the legend. Defaults to undefined.
   *
   * <p><em>Note</em> This applies to pie charts only.
   *
   * @param legendIndex Index in the legend.
   */
   ...
   *
   * @param marker Marker of the item.
   */
   ...
   * @return The marker of this data series item. If none is specified a new {@link Marker} will be
   *     created.
   */
  ...
  /**
   * Sets the ID for the point. This can be used after rendering to get a reference to the point
