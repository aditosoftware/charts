...
public class SkiesTheme extends HighChartsDefaultTheme {
  ...
  public SkiesTheme() {
    setColors(
        new SolidColor("#514F78"),
        new SolidColor("#42A07B"),
        new SolidColor("#9B5E4A"),
        new SolidColor("#72727F"),
        new SolidColor("#1F949A"),
        new SolidColor("#82914E"),
        new SolidColor("#86777F"),
        new SolidColor("#42A07B"));
    ...
    getChart().setPlotBackgroundImage("http://www.highcharts.com/demo/gfx/skies.jpg");
