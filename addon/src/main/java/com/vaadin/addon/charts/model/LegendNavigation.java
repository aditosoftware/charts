 ...
 * well on screen, but not in static exported images. One way of working around that is to <a href=
...
public class LegendNavigation extends AbstractConfigurationObject {
  ...
  /**
   * How to animate the pages when navigating up or down. A value of <code>true</code> applies the
   * default navigation given in the chart.animation option. Additional options can be given as an
  ...
  /**
   * Whether to enable the legend navigation. In most cases, disabling the navigation results in an
   * unwanted overflow.
   *
   * <p>Defaults to: true
   */
