...
/**
 * The default series type for the chart. Can be one of LINE, SPLINE, AREA, AREASPLINE, COLUMN, BAR,
 * PIE, SCATTER, AREARANGE, AREASPLINERANGE, and COLUMNRANGE. Defaults to LINE.
 *
 * <p>Own custom extensions can be made by extending this class.
 *
 * <p>Configuration specific to each ChartType can be set using {@link
 * Configuration#setPlotOptions(AbstractPlotOptions)} or for a single series using {@link
 * AbstractSeries#setPlotOptions(AbstractPlotOptions)}
 */
