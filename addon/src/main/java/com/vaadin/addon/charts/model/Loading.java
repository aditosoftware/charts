 ...
 * chart operations. This screen only appears after an explicit call to <code>chart.showLoading()
 * </code>. It is a utility for developers to communicate to the end user that something is going
 * on, for example while retrieving new data via an XHR connection. The "Loading..." text itself is
 * not part of this configuration object, but part of the <code>lang</code> object.
 */
@Generated(
...
public class Loading extends AbstractConfigurationObject {
   ...
   *
   * <p>Defaults to: { "fontWeight": "bold", "position": "relative", "top": "45%" }
   */
