...
public interface Series {
  ...
  /**
   * Define the visual z index of the series. With no z index, the series defined last are on top.
   * With a z index, the series with the highest z index is on top.
   *
   * @param zIndex to set to the series
   */
  ...
  /**
   * Sets the plot options for this specific series. The type of the plot options also explicitly
   * sets the chart type used when rendering this particular series. If plot options is null, the
   * component wide chart type is used.
   *
   * <p>Options that are not defined at this level will be inherited from the chart and theme
   * levels.
   *
   * @param plotOptions
   */
