...
/**
 * The dark version of the default theme for Vaadin Charts. Suitable for use with the Valo theme for
 * Vaadin.
 */
...
public class ValoDarkTheme extends Theme {
  ...
  protected static final SolidColor TITLE_COLOR = new SolidColor(255, 255, 255);
  protected static final SolidColor TOOLTIP_TEXT_COLOR = new SolidColor(51, 51, 51);
  protected static final SolidColor TOOLTIP_BACKGROUND_COLOR = new SolidColor(255, 255, 255, 0.9);
  protected static final SolidColor SUBTITLE_COLOR = new SolidColor(201, 201, 201);
  protected static final SolidColor LINE_COLOR = new SolidColor(54, 54, 54);
  protected static final SolidColor TEXT_COLOR = new SolidColor(148, 148, 148);
  protected static final SolidColor GRID_COLOR = new SolidColor(250, 250, 250);
  protected static final SolidColor LABEL_COLOR = new SolidColor(148, 148, 148);

  protected static final SolidColor BGCOLOR = new SolidColor(40, 40, 40);
  protected static final SolidColor BGCOLOR_LIGHT_GRAY = new SolidColor(0, 0, 0, 0.02);
  protected static final SolidColor TRANSPARENT_COLOR = new SolidColor(255, 255, 255, 0.0);

  protected static final String DEFAULT_FONT_FAMILIES =
      "Open Sans, Helvetica Neue, Arial, sans-serif";
  protected static final Color LEGEND_TEXT_COLOR = new SolidColor(155, 155, 155);
