...
public class DrillUpButton extends AbstractConfigurationObject {
  ...
  /**
   * Positioning options for the button within the {@link #setRelativeTo(DrillUpButtonRelativeTo)}
   * box.
   *
   * @param position
   */
  ...
  /**
   * What box to align the button to. Can be either {@link DrillUpButtonRelativeTo#PLOTBOX} or
   * {@link DrillUpButtonRelativeTo#SPACINGBOX}. Defaults to {@link DrillUpButtonRelativeTo#PLOTBOX}
   *
   * @param relativeTo
   */
