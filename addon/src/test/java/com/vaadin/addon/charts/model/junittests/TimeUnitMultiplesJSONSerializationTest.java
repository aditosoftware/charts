...
public class TimeUnitMultiplesJSONSerializationTest {
  ...
  public void toJSON_axisWithUnits_TimeUnitMultiplesCorrectlySerialized() {
    ...
    TimeUnitMultiples unitMillisecond =
        new TimeUnitMultiples(TimeUnit.MILLISECOND, 1, 2, 5, 10, 20, 25, 50, 100, 200, 500);
    ...
    yaxis.setUnits(
        unitMillisecond, unitSecond, unitMinute, unitHour, unitDay, unitWeek, unitMonth, unitYear);
