...
/**
 * Tests that {@link Labels} and {@link DataLabels} configuration options are serialized correctly
 * as JSON
 */
public class LabelsJSONSerializationTest {
  ...
  @Test
  public void toJSON_autoRotationLimitIsSet_labelsSerializedWithAutoRotationLimit()
      throws IOException {
