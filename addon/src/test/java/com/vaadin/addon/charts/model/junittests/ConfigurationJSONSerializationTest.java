...
public class ConfigurationJSONSerializationTest {
  ...
  @Test
  public void
      configurationJSONSerialization_configurationSerializedWithChangeListener_changeListenerNotSerialized() {
    Configuration conf = new Configuration();
    conf.addChangeListener(
    ...
    assertEquals(
        "{\"plotOptions\":{},\"series\":[],\"exporting\":{\"enabled\":false}}", toJSON(conf));
  }

  @Test
  public void
      configurationJSONSerialization_configurationSerializedWithYAxis_yAxisConfigurationNotSerialized() {
    Configuration conf = new Configuration();
  ...
  @Test
  public void
      configurationJSONSerialization_configurationSerializedWithLang_langConfigurationSerialized() {
    Configuration conf = new Configuration();
    Lang lang = new Lang();
  ...
  @Test
  public void
      configurationJSONSerialization_configurationSerializedWithoutLang_langConfigurationNotSerialized() {
    Configuration conf = new Configuration();
    assertEquals(
        "{\"plotOptions\":{},\"series\":[],\"exporting\":{\"enabled\":false}}", toJSON(conf));
  }
