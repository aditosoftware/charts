...
public class ChartDesignReaderTest {
  ...
  public void readConfiguration_tooltipWithColor_SolidColorIsInConfiguration() {
    ...
    assertEquals("#FF00FF", configuration.getTooltip().getBackgroundColor().toString());
  }
  ...
  @Test
  public void
      readConfiguration_chartTitleHasTextInAttibuteAndContent_theAttributeIsSetAsTitleText() {
    Elements elements =
        createElements("<chart-title text=\"my title\">this text should be ignored</chart-title>");
    Configuration configuration = new Configuration();
  ...
  public void readConfiguration_arrayProperty_theSameValuesAreInConfiguration() {
    ...
    assertArrayEquals(new String[] {"Jan", "Feb", "Mar"}, configuration.getxAxis().getCategories());
  }
  ...
  public void readConfiguration_multiValueNodes_allTheNodesAreInTheConfiguration() {
    Elements elements =
        createElements(
            "<y-axis><chart-title>First</chart-title></y-axis>"
  ...
  public void readConfiguration_plotOptionsWithOnSeriesProperty_onSeriesIsAddedToConfiguration() {
    ...
    assertEquals(
        "dataseries",
        ((PlotOptionsFlags) configuration.getPlotOptions(ChartType.FLAGS)).getOnSeries());
  }
  ...
  public void readConfiguration_multiplePlotOptions_plotOptionsLineIsAddedToConfiguration() {
    Elements elements =
        createElements("<plot-options><line></line><spline></spline></plot-options>");
    Configuration configuration = new Configuration();
  ...
  @Test
  public void
      readConfiguration_enableDataLabelsInPlotoptions_dataLabelsAreEnabledInConfiguration() {
    Elements elements =
        createElements(
  ...
  public void readConfiguration_arrayType_theNewValueIsAddedToArrayInConfiguration() {
    Elements elements =
        createElements(
            "<plot-options><treemap><levels level=\"1\"></levels></treemap></plot-options>");
    Configuration configuration = new Configuration();
  ...
  public void readConfiguration_titleWithStyleAsInnerElement_theTitleAndStyleAreInConfiguration() {
    Elements elements =
        createElements(
            "<chart-title text=\"foobar\"><chart-style top=\"12\"></chart-style></chart-title>");
    Configuration configuration = new Configuration();
  ...
  @Test
  public void
      readConfiguration_subtitleWithStyleAsInnerElement_theTitleAndStyleAreInConfiguration() {
    Elements elements =
        createElements(
            "<subtitle text=\"foobar\"><chart-style top=\"12\"></chart-style></subtitle>");
    Configuration configuration = new Configuration();
  ...
  @Test
  public void
      readConfiguration_chartHasLinearGradientBackgroundColor_theLinearGradientIsDefinedInConfiguration() {
    Elements elements =
        createElements(
  ...
  @Test
  public void
      readConfiguration_chartHasSolidBackgroundColor_theSolidColorIsDefinedInConfiguration() {
