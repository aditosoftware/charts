...
public class ChartDataSeriesJSONSerializationTest {
  ...
  public void serialize_ContainerWithXY_ValuesMappedAsArray() {
    ...
    final Pair<ListDataProvider<TestItem>, DataProviderSeries<TestItem>> pair =
  ...
  public void serialize_ContainerWithXOHLC_SerializedAsArray() {
    final Pair<ListDataProvider<TestItemOHLC>, DataProviderSeries<TestItemOHLC>> pair =
  ...
  public void serialize_ContainerItemWithMissingZ_MissingItemSerializedCorrectly() {
    final Pair<ListDataProvider<TestItem>, DataProviderSeries<TestItem>> pair =
        createTuple(new TestItem(80, 80, 80), new TestItem(20, 20, 20), new TestItem(10, 10, null));
  ...
  public void serialize_ContainerWithNonUTCDate_DateSerializedAsUTC() {
    ...
    final ZonedDateTime nowEuropeParis =
        ZonedDateTime.of(2010, 10, 10, 10, 39, 00, 00, ZoneId.of("Europe/Paris"));
    ...
    final DataProviderSeries<TestDateItem> chartDataSeriesEurope =
        new DataProviderSeries<>(dataProviderEurope);
    ...
    final DataProviderSeries<TestDateItem> chartDataSeriesUTC =
        new DataProviderSeries<>(dataProviderUTC);
