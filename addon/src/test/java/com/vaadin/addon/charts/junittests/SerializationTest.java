...
public class SerializationTest {
  ...
  public void serializeChart_chartConfigurationWithChangeListener_changeListenerSerialized()
    ...
    List<ConfigurationChangeListener> changeListenersBeforeSerialization =
        getPrivateField("changeListeners", input.getConfiguration(), Configuration.class);
    assertNotNull(
        "ChangeListeners was null before serialization", changeListenersBeforeSerialization);
    assertThat(
        "ChangeListeners was empty before serialization",
        changeListenersBeforeSerialization,
        is(not(empty())));

    Chart output = serializeObject(input);
    List<ConfigurationChangeListener> changeListenersAfterSerialization =
        getPrivateField("changeListeners", output.getConfiguration(), Configuration.class);
    assertNotNull(
        "ChangeListeners was null after serialization", changeListenersAfterSerialization);
    assertThat(
        "ChangeListeners was empty after serialization",
  ...
  public void serializeChart_configurationWithAxis_axisConfigLinkSerializedCorrectly()
    ...
    assertNotNull(
        "Axis config was null after serialization",
    ...
    assertEquals(
        getPrivateField("configuration", outputAxis, Axis.class), output.getConfiguration());
  }
  ...
  public void serializeChart_configurationWithDrilldown_drilldownSeriesListSerializedCorrectly()
    ...
    List<Series> outputDrilldownSeries =
        getPrivateField("drilldownSeries", outputSeries, DataSeries.class);
    assertNotNull("Drilldown series list was null after serialization", outputDrilldownSeries);
    assertThat(
        "Drilldown series list was empty after serialization",
  ...
  @Test
  public void
      serializeChart_configurationWithDrilldown_drilldownConfigurationLinkSerializedCorrectly()
          throws IOException, ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
    Chart input = new Chart();
    DataSeries dataSeries = new DataSeries();
    ListSeries drilldownSeries = new ListSeries();
  ...
  private <T> T serializeObject(T input) throws IOException, ClassNotFoundException {
