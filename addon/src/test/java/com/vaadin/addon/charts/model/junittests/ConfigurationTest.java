...
public class ConfigurationTest {
  ...
  public void testReverseListSeries() {
    assertTrue(((ListSeries) conf.getSeries().get(0)).getData()[0].intValue() == 1);
    assertTrue(((ListSeries) conf.getSeries().get(1)).getData()[0].intValue() == 4);
    assertTrue(((ListSeries) conf.getSeries().get(2)).getData()[0].intValue() == 7);
    assertTrue(((ListSeries) conf.getSeries().get(3)).getData()[0].intValue() == 10);

    assertTrue(((ListSeries) conf.getSeries().get(0)).getData()[1].intValue() == 2);
    assertTrue(((ListSeries) conf.getSeries().get(1)).getData()[1].intValue() == 5);
    assertTrue(((ListSeries) conf.getSeries().get(2)).getData()[1].intValue() == 8);
    assertTrue(((ListSeries) conf.getSeries().get(3)).getData()[1].intValue() == 11);

    conf.reverseListSeries();

    assertTrue(((ListSeries) conf.getSeries().get(0)).getData()[0].intValue() == 1);
    assertTrue(((ListSeries) conf.getSeries().get(1)).getData()[0].intValue() == 2);

    assertTrue(((ListSeries) conf.getSeries().get(0)).getData()[1].intValue() == 4);
    assertTrue(((ListSeries) conf.getSeries().get(1)).getData()[1].intValue() == 5);

    assertTrue(((ListSeries) conf.getSeries().get(0)).getData()[2].intValue() == 7);
    assertTrue(((ListSeries) conf.getSeries().get(1)).getData()[2].intValue() == 8);

    assertTrue(((ListSeries) conf.getSeries().get(0)).getData()[3].intValue() == 10);
    assertTrue(((ListSeries) conf.getSeries().get(1)).getData()[3].intValue() == 11);
  }
