...
public class ChartDesignWriterTest {
  ...
  @Test
  public void
      writeConfiguration_enableDataLabelsInPlotoptions_plotOptionsElementHasInnerTypeElement() {
    DesignContext designContext = new DesignContext();
    Configuration configuration = new Configuration();
  ...
  @Test
  public void
      writeConfiguration_plotOptionsWithReservedPropertyWord_prefixIsWrittenToReservedProperty() {
    DesignContext designContext = new DesignContext();
    Configuration configuration = new Configuration();
  ...
  private void assertPlotOptions(
      String type, String attribute, String attributeValue, Elements plotOptions) {
  ...
  @Test
  public void
      writeConfiguration_chartHasLinearGradientBackgroundColor_theLinearGradientIsWrittenAsElement() {
    Configuration configuration = new Configuration();
  ...
  @Test
  public void
      writeConfiguration_chartHasRadialGradientBackgroundColor_theRadialGradientIsWrittenAsElement() {
    Configuration configuration = new Configuration();
    DesignContext designContext = new DesignContext();
