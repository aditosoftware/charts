...
public class ChartsDemoUI extends UI {
  ...
  private static final String[] GROUP_CAPTIONS = {
    "Column and Bar",
    "Pie",
    "Area",
    "Line and Scatter",
  ...
  static {
    ...
    Set<Class<? extends AbstractVaadinChartExample>> subTypes =
        reflections.getSubTypesOf(AbstractVaadinChartExample.class);
    ...
    for (Class<? extends AbstractVaadinChartExample> class1 : subTypes) {
      ...
      List<Class<? extends AbstractVaadinChartExample>> list = grouped.get(name);
      if (list == null) {
        list = new ArrayList<>();
  ...
  protected void init(VaadinRequest request) {
    ...
    Link homepage =
        new Link("Home Page", new ExternalResource("https://vaadin.com/components/vaadin-charts"));
    Link javadoc =
        new Link(
            "JavaDoc",
            new ExternalResource(
                "http://demo.vaadin.com/javadoc/com.vaadin/vaadin-charts/" + getVersion() + "/"));
    Link manual =
        new Link(
            "Manual",
            new ExternalResource("https://vaadin.com/docs/v8/charts/charts-overview.html"));
    ...
    com.vaadin.addon.charts.model.style.Theme[] themes =
        new com.vaadin.addon.charts.model.style.Theme[] {
          defaultTheme,
          new ValoDarkTheme(),
          new VaadinTheme(),
          new HighChartsDefaultTheme(),
          new GridTheme(),
          new GrayTheme(),
          new SkiesTheme()
        };
    ...
    themeSelector.addSelectionListener(
        e -> {
   ...
   *
   * <p>Adds one tab with one example instance, one with the java source and another one with html
   * source in case of declarative example
   *
   * @param chartExample
   */
  private void updateTabSheet(Class chartExample) {
    try {
      ...
      AbstractVaadinChartExample newInstance =
          (AbstractVaadinChartExample) chartExample.newInstance();
    ...
    if (uriFragment != null) {
      ...
      for (Object object : itemIds) {
        if (object instanceof Class) {
          ...
          Class<? extends AbstractVaadinChartExample> t =
              (Class<? extends AbstractVaadinChartExample>) object;
