...
/**
 * A series that wraps a Vaadin Container. It is mutable only via the wrapped container. <br>
 * Wrapped Container should always have:
 *
 * <ul>
 *   <li>a property for y values
 *   <li>or a property for both high and low values
 * </ul>
 *
 * This can be achieved by using a container:
 *
 * <ul>
 *   <li>with a {@value #SERIES_DEFAULT_ATTRIBUTE2} property
 *   <li>or with a custom property for y values and use {@link #setYPropertyId(Object)} to set the
 *       custom property in the ContainerDataSeries instance
 *   <li>or with a custom property for both high and low values and use {@link
 *       #setHighPropertyId(Object)} and {@link #setLowPropertyId(Object)} to set the custom
 *       properties in the ContainerDataSeries instance
 * </ul>
 */
public class ContainerDataSeries extends AbstractSeries {

  static {
    ChartSerialization.setObjectMapperInstance(
        ChartSerialization.createObjectMapper(new CompatibilityBeanSerializerModifier()).writer());
  }

  @JsonIgnore private final Container vaadinContainer;
  ...
  @JsonIgnore private final Map<String, Object> attributeToPropertyIdMap;
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's X attribute
   *
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's Y attribute
   *
   * @param propertyId Id of a property.
   */
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's name attribute
   *
   * @param propertyId Id of a property.
   */
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's low attribute.
   *
   * @param propertyId Id of a property.
   */
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's high attribute.
   *
   * @param propertyId Id of a property.
   */
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's open attribute.
   *
   * @param propertyId Id of a property.
   */
  ...
  /**
   * Adds mapping that translates a property ID in the container into the chart's close attribute.
   *
   * @param propertyId Id of a property.
   */
  ...
  /**
   * Adds a mapping between a chart attribute (like x, y, name, id ...) and a property id in the
   * container.
   *
   * @param chartAttribute Attribute of a chart.
   * @param propertyId Id of a property.
   */
  public void addAttributeToPropertyIdMapping(String chartAttribute, Object propertyId) {
  ...
  /**
   * Returns current mappings. The map may be modified and it will affect this object.
   *
   * @return mappings between chart attributes (keys) and property IDs (values) in the container
   */
