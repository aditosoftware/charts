...
public class GettingStarted {
  ...
  public void addColumnsSnippet2(
      List<WeatherInfo> weatherInfo, DataProviderSeries<WeatherInfo> humidity, Configuration conf) {
  ...
  public void addColumnsSnippet4(ChartsData data, ListDataProvider<WeatherInfo> dataProvider) {
    dataProvider.addFilter(
        point -> {
          LocalDateTime date =
              LocalDateTime.ofInstant(point.getInstant(), ZoneId.of("Europe/Helsinki"));
