...
public class ChartTypes {
  ...
  public void chartTypesScatterMarkerSymbolsSnippet2() {
    ...
    String url =
        VaadinServlet.getCurrent().getServletContext().getContextPath()
            + "/VAADIN/themes/mytheme/img/smiley.png";
  ...
  public void chartTypesBubbleSnippet1() {
    ...
    String url =
        VaadinServlet.getCurrent().getServletContext().getContextPath()
            + "/VAADIN/themes/mytheme/img/map.png";
  ...
  public void chartTypesSolidGaugeAxisSnippet2() {
    ...
    Configuration conf = chart.getConfiguration();
    yaxis.setStops(
        new Stop(0.1f, SolidColor.GREEN),
  ...
  public void chartTypesTreemap() {
    ...
    series.addAll(
        apples, bananas, oranges, anneA, rickA, paulA, anneB, rickB, paulB, anneO, rickO, paulO,
        susanne);
  ...
  public void chartTypesFlagsExample() {
    ...
    flagsOnSeries.add(
        new FlagItem(1434585600000l, "First Series Flag", "First Series Flag Tooltip Text"));
    ...
    flagsOnAxis.add(
        new FlagItem(1434844800000l, "First Axis Flag", "First Axis Flag Tooltip Text"));
