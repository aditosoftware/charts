...
public class PointClickCoordinatesBarChartTBTest extends AbstractPointClickCoordinatesTest {
  ...
  protected void clickPoint() {
    WebElement element = driver.findElement(By.cssSelector(".highcharts-series-2 > rect"));
