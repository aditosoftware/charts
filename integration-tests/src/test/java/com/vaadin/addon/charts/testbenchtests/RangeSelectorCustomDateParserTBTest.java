...
public class RangeSelectorCustomDateParserTBTest extends AbstractSimpleScreenShotTestBenchTest {
  ...
  private WebElement findRangeStartInput() {
    List<WebElement> list =
        driver.findElements(
            com.vaadin.testbench.By.cssSelector(
                "#highcharts-0 > svg > g.highcharts-input-group > g:nth-child(2) > text"));
    return list.get(0);
  }
  ...
  private WebElement findRangeEndInput() {
    List<WebElement> list =
        driver.findElements(
            com.vaadin.testbench.By.cssSelector(
                "#highcharts-0 > svg > g.highcharts-input-group > g:nth-child(4) > text"));
    return list.get(0);
  }
}
