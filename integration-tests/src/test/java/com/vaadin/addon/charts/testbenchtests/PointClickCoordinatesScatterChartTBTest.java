...
public class PointClickCoordinatesScatterChartTBTest extends AbstractPointClickCoordinatesTest {
  ...
  protected void clickPoint() {
    WebElement element = driver.findElement(By.cssSelector(".highcharts-series-2 > path"));
  ...
  protected void assertPointClickEventCoordinates() {
    skipBrowser("For some reason Firefox gets wrong event type.", Browser.FIREFOX);
