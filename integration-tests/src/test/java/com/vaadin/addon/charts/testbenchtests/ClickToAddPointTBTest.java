...
public class ClickToAddPointTBTest extends AbstractSimpleScreenShotTestBenchTest {
  ...
  protected void testCustomStuff() {
    ...
    Action click = new Actions(driver).moveToElement(findElement, 200, 200).click().build();
